...
happyTokenStrings = ["':'","increment","decrement","ident","%eof"]

happyActOffsets :: HappyAddr
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#

happyDefActions :: HappyAddr
happyDefActions = HappyA# "\x00\x00\x00\x00\x00\x00\x00\x00\xfe\xff\xff\xff\xfd\xff\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xfc\xff\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xfb\xff\xff\xff\x00\x00\x00\x00\xfa\xff\xff\xff"#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyRuleArr = HappyA# "\x00\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x02\x00\x00\x00\x02\x00\x00\x00\x05\x00\x00\x00\x02\x00\x00\x00\x06\x00\x00\x00"#

happyCatchStates :: [Happy_Prelude.Int]
happyCatchStates = []

happy_n_terms = 7 :: Happy_Prelude.Int
...
happyReduction_4 ((HappyTerminal (TIdent happy_var_5)) `HappyStk`
        ...
        happyRest)
         = HappyAbsSyn7
                 ((happy_var_1, Increment happy_var_4 happy_var_5)
        ) `HappyStk` happyRest

happyReduce_5 = happyReduce 6# 2# happyReduction_5
happyReduction_5 ((HappyTerminal (TIdent happy_var_6)) `HappyStk`
        (HappyTerminal (TIdent happy_var_5)) `HappyStk`
        (HappyTerminal (TIdent happy_var_4)) `HappyStk`
        _ `HappyStk`
        _ `HappyStk`
        (HappyTerminal (TIdent happy_var_1)) `HappyStk`
        happyRest)
         = HappyAbsSyn7
                 ((happy_var_1, Decrement happy_var_4 happy_var_5 happy_var_6)
        ) `HappyStk` happyRest
...
happyNewToken action sts stk = happyLex (\tk -> happyDoAction 6# notHappyAtAll action sts stk) (\i tk -> happyDoAction i tk action sts stk)

happyReport 6# tk explist resume tks = happyReport' tks explist resume
...
parseAbacus tks = happyRunIdentity happySomeParser where
